...
# Start 3 vLLM processes with explicit GPU assignment
# Process 1: GPUs 0-1, Port 8000, TP=2
# Process 2: GPUs 2-3, Port 8001, TP=2
# Process 3: GPUs 4-5, Port 8002, TP=2
...
echo "Starting 3 vLLM processes..."
...
echo ""
echo "All 3 vLLM processes started successfully."
echo "Process PIDs: $PID1 $PID2 $PID3"
echo ""
echo "Log files:"
